...
pub struct ImageLayers<'a> {
    ...
    pub data: &'a FxHashMap<GraphicKey, GraphicDataEntry>,
}
...
pub fn render_cpu(
    ...
    let frame_hash = {
        ...
        for overlay in &image_overlays {
            h.write_usize(overlay.image_id.route_id);
            h.write_u64(overlay.image_id.image_id);
